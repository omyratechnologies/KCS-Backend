...
export const schoolBankDetailsSchema = z
    .object({
...
export const createBankDetailsRequestSchema = z
    .object({
        bank_name: z.string().openapi({ example: "State Bank of India" }),
        account_number: z.string().openapi({ example: "1234567890" }),
        account_holder_name: z.string().openapi({ example: "ABC School Trust" }),
...
export const feeCategorySchema = z
    .object({
...
export const createFeeCategoryRequestSchema = z
    .object({
        category_name: z.string().openapi({ example: "Tuition Fee" }),
        category_code: z.string().openapi({ example: "TUITION_001" }),
        description: z.string().openapi({ example: "Monthly tuition fee for academic year" }),
...
export const feeTemplateSchema = z
    .object({
...
export const createFeeTemplateRequestSchema = z
    .object({
        template_name: z.string().openapi({ example: "Class 10 Monthly Fee" }),
        class_id: z.string().openapi({ example: "class_123" }),
        academic_year: z.string().openapi({ example: "2023-24" }),
        fee_structure: z.array(
            z.object({
                category_id: z.string(),
                category_name: z.string(),
                amount: z.number(),
...
export const enhancedFeeSchema = z
    .object({
...
export const studentFeesResponseSchema = z
    .object({
        success: z.boolean().openapi({ example: true }),
        data: z.object({
...
export const availableGatewaysResponseSchema = z
    .object({
        success: z.boolean().openapi({ example: true }),
        data: z.object({
            gateways: z.array(
...
export const generateFeesRequestSchema = z
    .object({
