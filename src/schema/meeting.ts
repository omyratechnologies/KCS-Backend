...
export const meetingSchema = z
    .object({
        ...
        participants: z.array(z.string()).openapi({ example: ["user1", "user2", "user3"] }),
        ...
        meeting_start_time: z.string().openapi({ example: "2023-05-15T10:00:00Z" }),
        meeting_end_time: z.string().openapi({ example: "2023-05-15T11:30:00Z" }),
...
export const updateMeetingRequestBodySchema = z
    .object({
        ...
        meeting_name: z.string().optional().openapi({ example: "Updated Staff Meeting" }),
        meeting_description: z.string().optional().openapi({ example: "Updated discussion topics" }),
        meeting_start_time: z.string().optional().openapi({ example: "2023-05-15T10:30:00Z" }),
        meeting_end_time: z.string().optional().openapi({ example: "2023-05-15T12:00:00Z" }),
        meeting_location: z.string().optional().openapi({ example: "Conference Room B" }),
        meeting_meta_data: z
...
export const getMeetingsResponseSchema = z.array(meetingSchema).openapi({ ref: "GetMeetingsResponse" });
