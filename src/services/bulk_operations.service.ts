...
export class BulkOperationsService {
    ...
    static async generateBulkFees(
        ...
        try {
            ...
            // Get target students
            const targetStudents = await this.getTargetStudents(
                campus_id,
                request.class_ids,
                request.student_ids
            );
    ...
    static async processBulkPayments(
        ...
        try {
            ...
            // Get target fees
            const targetFees = await this.getTargetFees(
                campus_id,
                request.student_ids,
                request.fee_ids
            );
    ...
    private static async applyAutoDiscounts(
        campus_id: string,
        fee_id: string,
        student_id: string
    ): Promise<void> {
    ...
    private static async processAdminPayment(
        campus_id: string,
        fee: IFeeData,
        processed_by: string
    ): Promise<void> {
    ...
    private static async sendFeeGenerationNotification(
        campus_id: string,
        fee: any,
        student: any
    ): Promise<void> {
