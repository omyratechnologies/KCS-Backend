...
// ========================= SCHOOL BANK DETAILS =========================
paymentRoutes.post("/school-bank-details", PaymentController.createOrUpdateBankDetails);
...
paymentRoutes.post("/fee-templates/:template_id/generate", PaymentController.generateFeesFromTemplate);

// ========================= PAYMENT PROCESSING =========================
paymentRoutes.post("/initiate-payment", PaymentController.initiatePayment);
paymentRoutes.post("/verify-payment/:transaction_id", PaymentController.verifyPayment);
...
paymentRoutes.get("/available-gateways", PaymentController.getAvailableGateways);
paymentRoutes.get("/invoices/:invoice_id/download", PaymentController.downloadInvoice);

// ========================= SECURE CREDENTIAL MANAGEMENT =========================
paymentRoutes.post("/secure-credentials", PaymentController.configureSecureCredentials);
paymentRoutes.post("/test-gateway/:gateway", PaymentController.testGatewayConfiguration);
paymentRoutes.put("/toggle-gateway/:gateway", PaymentController.toggleGateway);
paymentRoutes.get("/credentials/masked", PaymentController.getMaskedCredentials);
paymentRoutes.post("/migrate-credentials", PaymentController.migrateLegacyCredentials);
...
paymentRoutes.post("/bulk-reminders", PaymentController.sendBulkPaymentReminders);
paymentRoutes.post("/reminder/:fee_id", PaymentController.sendPaymentReminder);
paymentRoutes.post("/schedule-reminders", PaymentController.schedulePaymentReminders);
...
paymentRoutes.get("/discounts/eligibility/:fee_id/:student_id", PaymentController.checkDiscountEligibility);
...
paymentRoutes.post("/bulk/process-payments", PaymentController.processBulkPayments);
